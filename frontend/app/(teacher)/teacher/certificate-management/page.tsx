      ...
      <div className="panel overflow-hidden">
        <div className="max-w-4xl">
          ...
          <h2 className="teacher-panel-heading mt-3 text-4xl font-black tracking-tight">
            Review issued certificate records and trace them back to the students and batches you
            currently manage.
          </h2>
          <p className="teacher-panel-copy mt-3 text-sm leading-relaxed">
            This ledger shows teacher-reviewed certificate records. The batch column reflects the
            student&apos;s current advisory batch based on the latest approved enrollment so you can
            quickly open the right learner record and certificate preview.
          </p>
        </div>
      </div>
      ...
      <div className="panel space-y-4">
        <div className="flex flex-col gap-4 xl:flex-row xl:items-end xl:justify-between">
          <div>
            ...
            <p className="teacher-panel-copy mt-2 text-sm">
              Search by student, advisory batch, certificate reference, teacher, or note. Keep the
              default view for issued certificates only, or expand it to see rejected reviews too.
            </p>
          </div>
